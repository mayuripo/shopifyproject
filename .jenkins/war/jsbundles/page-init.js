...
/* harmony import */ var jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
/* harmony import */ var jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1__);
...
function loadScripts() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jenkins-js-load').each(function () {
    ...
    if (scriptUrl) {
      ...
      jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1___default.a.addScript(scriptUrl);
...
function loadCSS() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.jenkins-css-load').each(function () {
    ...
    if (cssUrl) {
      ...
      // loaded once and once only. So, this can be considered
      // analogous to a client-side adjunct.
      jenkins_js_modules__WEBPACK_IMPORTED_MODULE_1___default.a.addCSSToPage(cssUrl);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).remove();
    }
  });
}
