...
var tabPanes = document.querySelectorAll(".jenkins-tab-pane");
var content = document.querySelector("#main-panel"); // Hide tab panes
...
tabPanes.forEach(function (tabPane, index) {
  var tabPaneTitle = tabPane.querySelector(".jenkins-tab-pane__title");
