...
function registerSortableDragDrop(e) {
  ...
  var sortableElement = new sortablejs_modular_sortable_core_esm_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "b"](e, {
    ...
    onChoose: function onChoose(event) {
      var draggableDiv = event.item;
      var height = draggableDiv.clientHeight;
